    ...
    const scoreSeeds = [
      {
        ...
        brevityScore: "86.40",
        engagementScore: "91.20",
        popularityScore: "88.10",
      ...
      },
      {
        ...
        brevityScore: "81.20",
        engagementScore: "84.40",
        popularityScore: "79.20",
      ...
      await tx
        ...
        .onConflictDoUpdate({
          ...
          set: {
            ...
            bayesianRating: scoreRow.bayesianRating,
            difficultyMultiplier: scoreRow.difficultyMultiplier,
            brevityScore: scoreRow.brevityScore,
            engagementScore: scoreRow.engagementScore,
            popularityScore: scoreRow.popularityScore,
